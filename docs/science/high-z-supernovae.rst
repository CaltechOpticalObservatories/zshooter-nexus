...
- Classification and physics both push the instrument toward broad coverage and high throughput.
- NIR coverage is not a bolt-on here.
- A low-resolution path is useful, but it should not define the whole instrument.
...
- Add one concise target-magnitude / cadence block once the science team picks a representative program.
