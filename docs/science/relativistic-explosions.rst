...
- Rapid ToO execution is part of the science case.
- Broad SED coverage keeps extinction, redshift, and continuum shape in one exposure.
- Imaging fallback still matters for the faint or already-faded end of the sample.
...
- Decide how much of the GRB vs. LFBOT split should be explicit here versus deferred to later pages.
