...
- Balmer-jump through Br-gamma coverage belongs in one instrument if you can get it.
- The science likes simultaneous diagnostics more than stitched campaigns.
- This case is a good use of the instrument in non-ToO time.
...
- Add a concise line list and one representative observing template when the page is fleshed out.
