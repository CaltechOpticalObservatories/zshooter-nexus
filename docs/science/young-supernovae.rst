...
- Flash spectroscopy wants early response and blue-end reach.
- Narrow CSM structure pushes against purely low-resolution thinking.
- Single-visit optical-to-IR coverage keeps the evolving picture coherent.
...
- Add a short note on line windows that the team considers non-negotiable.
