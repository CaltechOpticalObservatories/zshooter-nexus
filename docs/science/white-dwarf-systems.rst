...
- The bluest useful transitions are not optional if the goal is an abundance inventory.
- Simultaneous blue-to-NIR access beats stitching together separate instruments and nights.
...
- **The page also helps tell the story that ZShooter is a future workhorse beyond transient triage.**
- Separate atmospheric pollution, gaseous disks, and dust-SED uses once real page owners step in.
- Add one concise table mapping resolution regime to WD sub-case.
