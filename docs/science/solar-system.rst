...
- Reflectance and gas diagnostics benefit from continuous optical-NIR coverage.
- Rapid-response opportunities exist for outbursts and rare visitors.
- Imaging context and non-sidereal operations matter here in a way many other pages do not.
...
- Eventually split moving-target operations from the composition story.
